...
function Table<T>({ data = [], column, handleFetchMore, hasNextPage, error }: TableProps<T>) {
    ...
    return (
        <>
            {error && <div className="bg-red-100 border-red-500 mt-10 p-4 rounded-md">request failed to get data !!!</div>}
            {!error &&
